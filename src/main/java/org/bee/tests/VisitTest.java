...
import org.bee.billing.BillableItem;
import org.bee.humans.Doctor;
import org.bee.humans.Nurse;
import org.bee.humans.Patient;
import java.math.BigDecimal;
import java.time.LocalDateTime;
import java.util.List;
import org.bee.medical.DiagnosticCode;
import org.bee.medical.Medication;
import org.bee.medical.ProcedureCode;
import org.bee.medical.Visit;
import org.bee.medical.VisitStatus;
import org.bee.medical.WardStay;
...
public class VisitTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Initial status: " + visit2.getStatus());
            visit2.updateStatus(VisitStatus.IN_PROGRESS);
            System.out.println("After updating to IN_PROGRESS: " + visit2.getStatus());
            System.out.println("Is in progress: " + visit2.isInProgress());
            visit2.updateStatus(VisitStatus.DISCHARGED);
            System.out.println("After updating to DISCHARGED: " + visit2.getStatus());
            System.out.println("Is patient discharged? : " + visit2.isDischarged());
            System.out.println("Is the visit finalized: " + visit2.isFinalized());
            visit2.displayVisitInfo();

            // Test 3: Create a visit with random data
            System.out.println("\nTest 3 - Creating visit with random data:");
            Visit visit3 = Visit.withRandomData();
            System.out.println("Random visit created with status: " + visit3.getStatus());
            visit3.displayVisitInfo();
            ...
            Visit visit5 = Visit.createNew(LocalDateTime.now(), patient);
            visit5.updateStatus(VisitStatus.DISCHARGED);
            
            // Test prescribing to discharged patient
            try {
                visit5.prescribeMedicine(Medication.getRandomMedication(), 1);
            ...
            try {
                visit5.updateStatus(VisitStatus.IN_PROGRESS);
            ...
            try {
                visit4.prescribeMedicine(Medication.getRandomMedication(), 0);
            ...
            try {
                visit4.prescribeMedicine(null, 1);
