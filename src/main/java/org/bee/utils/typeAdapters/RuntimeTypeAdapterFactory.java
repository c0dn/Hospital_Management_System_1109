 ...
 * }</pre>
 * 
 * <p>Without this adapter, GSON will not know which implementation of Human to instantiate
 * when deserializing a field of type Human.
 *
 * <p>This adapter solves this problem by adding a type field to the serialized JSON and then
 * using that type information to determine which class to instantiate during deserialization.
 *
 * <p>Implementation based on the RuntimeTypeAdapterFactory from gson-extras.
 */
